              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">hello@nextapp.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">123 Tech Street, San Francisco, CA 94105</p>
                  </div>
                </div>
              </CardContent>
            </Card>
