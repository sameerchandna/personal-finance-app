...
-- Since we're using Clerk, we'll use a more permissive policy for now
-- You can tighten this later by implementing proper Clerk-Supabase integration
...
-- In production, you should implement proper user verification
CREATE POLICY "Allow all operations for authenticated users" ON public.mortgage_profiles
